...
<img {...colorContrast} alt="Illustration of different contrast ratios" />
...
<img {...semanticElements} alt="Comparison between semantic elements like header, article, figure, and footer versus divs everywhere for a page layout" />
