...
<Image src={colorContrast} alt="Illustration of different contrast ratios" width={800} height={144} />
...
<Image src={progressBar} alt="Progress bar without any labelling" width={720} height={60} />
